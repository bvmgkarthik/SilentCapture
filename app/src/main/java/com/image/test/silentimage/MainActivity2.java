package com.image.test.silentimage;
...
public class MainActivity2 extends AppCompatActivity implements ActivityCompat.OnRequestPermissionsResultCallback {
    ...
    CameraControllerV2WithoutPreview ccv2WithPreview;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(showpreview) {
            ccv2WithPreview = new CameraControllerV2WithoutPreview(getApplicationContext());
